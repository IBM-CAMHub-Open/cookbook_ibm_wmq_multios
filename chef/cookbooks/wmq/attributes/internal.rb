...
force_default['wmq']['sw_repo_path'] = node['ibm']['sw_repo'] + '/wmq/v' + node['wmq']['version']
...
when 'rhel'
  ...
  when 's390x'
    ...
    # <> WebSphere MQ Server version gsk inside archive
    force_default['wmq']['gskpackages'] = "MQSeriesGSKit-#{node['wmq']['gskpackages']}.s390x.rpm"
