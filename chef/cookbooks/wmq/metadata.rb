...
attribute 'wmq/fixpack',
          ...
          :selectable => 'false',
          :type => 'string'
attribute 'wmq/gskversion',
          :default => '8.0.0-4',
          :description => 'The Version of GSK install with MQSeries',
          :displayname => 'MQSeriesGSKVersion',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
          :secret => 'false',
...
attribute 'wmq/perms',
          ...
          :selectable => 'false',
          :type => 'string'
attribute 'wmq/qmgr/qmgr1/description',
...
attribute 'wmq/qmgr/qmgr1/dlq',
          ...
          :selectable => 'false',
          :type => 'string'
attribute 'wmq/qmgr/qmgr1/listener_port',
          :default => '1414',
          ...
          :selectable => 'false',
          :type => 'string'
attribute 'wmq/qmgr/qmgr1/loggingtype',
          :choice => ['ll', 'lc'],
          :default => 'lc',
          ...
          :selectable => 'true',
          :type => 'string'
attribute 'wmq/qmgr/qmgr1/logsize',
          :default => '16384',
...
attribute 'wmq/qmgr/qmgr1/name',
          ...
          :selectable => 'false',
          :type => 'string'
attribute 'wmq/qmgr/qmgr1/primarylogs',
          :default => '10',
          ...
          :selectable => 'false',
          :type => 'string'
attribute 'wmq/qmgr/qmgr1/secondarylogs',
          :default => '20',
...
attribute 'wmq/version',
          :choice => ['8.0', '9.0'],
          :default => '8.0',
          :description => 'The Version of MQSeries to install.',
          :displayname => 'MQSeriesVersion',
          :parm_type => 'node',
          :precedence_level => 'node',
          :required => 'recommended',
